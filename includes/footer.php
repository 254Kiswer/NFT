...
<div class="container my-5">
    <!-- Footer -->
    <footer class="text-center text-black" style="background-color: #61dafbaa; height:50vh; border-radius: 10px;">
        <!-- Grid container -->
        <div class="container">
            <!-- Section: Links -->
            <section class="mt-5">
                ...
                <div class="row text-center d-flex justify-content-center pt-5">
                    ...
                    <div class="col-md-2">
                        <h6 class="text-uppercase font-weight-bold">
                            <a href="<?php echo APPURL; ?>/index.php" class="text-white">About</a>
                        </h6>
                    </div>
                    <!-- Grid column -->
                    ...
                    <div class="col-md-2">
                        <h6 class="text-uppercase font-weight-bold">
                            <a href="<?php echo APPURL; ?>/contact.php" class="text-white">Contact Us</a>
                        </h6>
                    </div>
                    <!-- Grid column -->
                </div>
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
            © 2020 Copyright:
            <a class="text-white" href="https://www.autoportsfreight.com">www.autoportsfreight.com</a>
        </div>
        <!-- Copyright -->
    </footer>
    <!-- Footer -->
